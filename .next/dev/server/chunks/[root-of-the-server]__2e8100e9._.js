...
"[project]/Planeamento dental/planeamento-dental/pages/api/admin/questions/index.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Planeamento__dental$2f$planeamento$2d$dental$2f$src$2f$lib$2f$api$2d$shared$2f$auth$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["requireAdmin"])(req, res, async ()=>{
          ...
          `;
                    ...
                    try {
                        ...
                        result = await __TURBOPACK__imported__module__$5b$project$5d2f$Planeamento__dental$2f$planeamento$2d$dental$2f$src$2f$lib$2f$api$2d$shared$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].query(query, params);
                    ...
                    const questionsWithOptions = await Promise.all(result.rows.map(async (q, index)=>{
                        if (index === 0) {
                        ...
                        if (q.type === 'single_select' || q.type === 'multi_select') {
                            ...
                            q.options = optionsResult.rows.map((opt)=>({
                                    id: opt.id,
                                    label: opt.label,
                                    value: opt.value,
                        ...
                        if (hasQuestionContexts) {
                            ...
                            const hasContext = q.why !== null && q.why !== undefined || q.consequences !== null && q.consequences !== undefined || q.how_to_answer !== null && q.how_to_answer !== undefined || q.good_examples !== null && q.good_examples !== undefined || q.bad_examples !== null && q.bad_examples !== undefined;
                            if (hasContext) {
                ...
                if (method === 'POST') {
                    const { question_set_id, code, text, help_text, type, required, order_index, validation_schema, ai_importance_weight, options, context } = req.body;
                    ...
                    if (!question_set_id || !code || !text || !type) {
                        return res.status(400).json({
                            error: 'Campos obrigatórios: question_set_id, code, text, type'
                        });
                    }
                    ...
                    const existingQuestion = await __TURBOPACK__imported__module__$5b$project$5d2f$Planeamento__dental$2f$planeamento$2d$dental$2f$src$2f$lib$2f$api$2d$shared$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].query('SELECT id, text FROM questions WHERE question_set_id = $1 AND code = $2', [
                        question_set_id,
                        code
                    ]);
                    ...
                    if (validation_schema && typeof validation_schema === 'object') {
                        ...
                        const cleaned = Object.fromEntries(Object.entries(validation_schema).filter(([_, v])=>v !== undefined && v !== null && v !== ''));
                    ...
                    // Criar pergunta
                    const questionResult = await __TURBOPACK__imported__module__$5b$project$5d2f$Planeamento__dental$2f$planeamento$2d$dental$2f$src$2f$lib$2f$api$2d$shared$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].query(`INSERT INTO questions (
            ...
            `);
             ...
             WHERE q.id = $1`;
                    ...
                    const fullQuestionResult = await __TURBOPACK__imported__module__$5b$project$5d2f$Planeamento__dental$2f$planeamento$2d$dental$2f$src$2f$lib$2f$api$2d$shared$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].query(fullQuestionQuery, [
                        question.id
                    ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2e8100e9._.js.map