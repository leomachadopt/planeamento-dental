...
"[project]/Planeamento dental/planeamento-dental/pages/api/admin/stats.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
            ...
            try {
                if (req.method === 'GET') {
                    ...
                    const [usersResult, clinicsResult, reportsResult] = await Promise.all([
                        __TURBOPACK__imported__module__$5b$project$5d2f$Planeamento__dental$2f$planeamento$2d$dental$2f$src$2f$lib$2f$api$2d$shared$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].query('SELECT COUNT(*) as total, COUNT(*) FILTER (WHERE is_active = true) as active FROM users'),
                        __TURBOPACK__imported__module__$5b$project$5d2f$Planeamento__dental$2f$planeamento$2d$dental$2f$src$2f$lib$2f$api$2d$shared$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].query('SELECT COUNT(*) as total FROM clinics'),
                        __TURBOPACK__imported__module__$5b$project$5d2f$Planeamento__dental$2f$planeamento$2d$dental$2f$src$2f$lib$2f$api$2d$shared$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].query(`
              SELECT 
                COUNT(*) as total,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e88d94e4._.js.map