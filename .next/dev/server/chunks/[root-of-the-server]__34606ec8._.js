...
"[project]/Planeamento dental/planeamento-dental/pages/api/admin/reports.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Planeamento__dental$2f$planeamento$2d$dental$2f$src$2f$lib$2f$api$2d$shared$2f$auth$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["requireAdmin"])(req, res, async ()=>{
            try {
                if (req.method === 'GET') {
                    ...
                    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$Planeamento__dental$2f$planeamento$2d$dental$2f$src$2f$lib$2f$api$2d$shared$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].query(`
            SELECT 
              r.id,
              r.clinic_id,
              r.report_type,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__34606ec8._.js.map