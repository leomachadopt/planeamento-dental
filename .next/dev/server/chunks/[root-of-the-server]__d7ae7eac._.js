...
"[project]/Planeamento dental/planeamento-dental/pages/api/dossiers/[id]/entities/capacities.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        try {
            ...
            if (method === 'GET') {
                if (entityId) {
                    ...
                    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$Planeamento__dental$2f$planeamento$2d$dental$2f$src$2f$lib$2f$api$2d$shared$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].query(`SELECT * FROM ${TABLE_NAME} WHERE clinic_id = $1 AND dossier_id = $2 ORDER BY resource_type, created_at`, [
                        clinicId,
                        dossierId
                    ]);
           ...
           RETURNING *`, [
                ...
                const sectionCode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Planeamento__dental$2f$planeamento$2d$dental$2f$src$2f$lib$2f$api$2d$shared$2f$staleTracking$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["getSectionForEntity"])('capacities');
                if (sectionCode) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d7ae7eac._.js.map