...
"[project]/Planeamento dental/planeamento-dental/pages/api/dossiers/[id]/entities/team-members.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Planeamento__dental$2f$planeamento$2d$dental$2f$src$2f$lib$2f$api$2d$shared$2f$auth$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["authenticateToken"])(req, res, async ()=>{
        try {
            ...
            if (method === 'GET') {
                if (entityId) {
                    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$Planeamento__dental$2f$planeamento$2d$dental$2f$src$2f$lib$2f$api$2d$shared$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].query(`SELECT tm.*, r.name as role_name, r.description as role_description
             FROM ${TABLE_NAME} tm
             LEFT JOIN roles r ON r.id = tm.role_id
             WHERE tm.id = $1 AND tm.clinic_id = $2 AND tm.dossier_id = $3`, [
                        entityId,
                        clinicId,
                        dossierId
                    ]);
             ...
             FROM ${TABLE_NAME} tm
             LEFT JOIN roles r ON r.id = tm.role_id
             WHERE tm.clinic_id = $1 AND tm.dossier_id = $2
            ...
            if (method === 'POST') {
                const { name, roleId, employmentType, hoursPerWeek, notes } = req.body;
                if (!name || !employmentType) {
                    return res.status(400).json({
                        error: 'name e employmentType são obrigatórios'
                    });
                }
                const result = await __TURBOPACK__imported__module__$5b$project$5d2f$Planeamento__dental$2f$planeamento$2d$dental$2f$src$2f$lib$2f$api$2d$shared$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].query(`INSERT INTO ${TABLE_NAME} (clinic_id, dossier_id, name, role_id, employment_type, hours_per_week, notes, status)
           ...
           RETURNING *`, [
                ...
                const sectionCode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Planeamento__dental$2f$planeamento$2d$dental$2f$src$2f$lib$2f$api$2d$shared$2f$staleTracking$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["getSectionForEntity"])('team_members');
                if (sectionCode) {
            ...
            if (method === 'PUT' && entityId) {
                const { name, roleId, employmentType, hoursPerWeek, notes, status } = req.body;
                const updateFields = [];
                const updateValues = [];
                let paramIndex = 1;
                if (name !== undefined) {
                ...
                if (hoursPerWeek !== undefined) {
                    ...
                    updateValues.push(hoursPerWeek);
                }
                if (notes !== undefined) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c1018c66._.js.map