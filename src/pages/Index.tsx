...
export default function Index() {
  ...
  const loadDossiers = async () => {
    ...
    try {
      setLoading(true)
      // Buscar dossiês da clínica usando a função API correta
      const data = await api.getDossiers(user.clinicId)
      setDossiers(data)

      // Carregar relatórios de cada dossiê
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex gap-2 pt-2">
                    <Button 
                      ...
                      className="flex-1"
                    >
                      <Link to={`/dossie/${dossier.id}/identity`}>
                        Abrir Dossiê
                    ...
                    {hasReports && (
                      <Button 
                        ...
                        size="sm"
                      >
                        <Link to={`/dossie/${dossier.id}/relatorios`}>
